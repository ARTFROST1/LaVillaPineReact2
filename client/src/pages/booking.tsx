          ...
          <div className="backdrop-blur-md rounded-xl shadow-2xl p-8 bg-[#ffffff00]">
            ...
            <div className="mt-8 text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link href="/contacts">
                  <Button className="bg-accent/20 hover:bg-white/20 hover:text-white text-accent border-2 border-accent hover:border-white backdrop-blur-sm transition-all duration-300 shadow-lg">
                    <i className="fas fa-envelope mr-2"></i>
                    Связаться с нами
                  </Button>
                </Link>
                <a href={`tel:${SITE_CONFIG.phone}`}>
                  <Button variant="outline" className="bg-white/20 hover:bg-white/20 border-2 border-accent text-accent hover:text-white backdrop-blur-sm transition-all duration-300 shadow-lg">
