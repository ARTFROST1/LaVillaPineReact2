      ...
      <div className="relative">
        {AMENITIES.map((amenity, index) => (
          <div
            ...
            className="sticky top-32 w-full h-screen flex items-end justify-center px-4 pb-52"
            style={{
              opacity: 0,
          ...
          >
            <div
              className="w-full max-w-6xl h-[70vh] rounded-3xl overflow-hidden shadow-2xl group"
              style={{
                willChange: "transform",
