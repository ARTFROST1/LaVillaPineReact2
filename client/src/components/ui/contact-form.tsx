    ...
    <div className="bg-neutral p-8 rounded-xl shadow-lg">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        ...
        <Button
          ...
          className="w-full bg-accent hover:bg-white/20 hover:backdrop-blur-sm hover:text-white text-white border-2 border-accent hover:border-white transition-all duration-300 shadow-lg"
        >
          {isSubmitting ? (
            <>
