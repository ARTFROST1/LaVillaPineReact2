...
export default function ComingSoonBanner({
  ...
  return (
    <div
      className={`backdrop-blur-md rounded-xl shadow-2xl p-4 sm:p-6 md:p-8 ${isHomePage ? "bg-white/10" : "bg-white/95"} ${className}`}
    >
      <div className="text-center">
        <div className="mb-4 sm:mb-6">
          <Calendar
            className={`w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 mx-auto mb-3 sm:mb-4 ${isHomePage ? "text-accent" : "text-primary"}`}
          />
          <h2
            className={`text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold mb-3 sm:mb-4 ${isHomePage ? "text-white" : "text-primary"}`}
          >
            Скоро открытие!
          </h2>
          <p
            className={`text-base sm:text-lg md:text-xl mb-2 ${isHomePage ? "text-gray-100" : "text-gray-700"}`}
          >
            Мы начинаем принимать брони
          </p>
          <p
            className={`text-lg sm:text-xl md:text-2xl font-semibold ${isHomePage ? "text-accent" : "text-primary"}`}
          >
            C 20 августа 2025
          </p>
        </div>
        ...
        <div className="mb-6 sm:mb-8">
          <p
            className={`text-sm sm:text-base md:text-lg mb-3 sm:mb-4 ${isHomePage ? "text-gray-200" : "text-gray-600"}`}
          >
            Узнайте первыми о нашем открытии и специальных предложениях
          </p>
          <p
            className={`text-xs sm:text-sm md:text-base ${isHomePage ? "text-gray-300" : "text-gray-500"}`}
          >
        ...
        <div className="flex flex-wrap justify-center gap-2 sm:gap-3 md:gap-4 mb-6 sm:mb-8">
          <a
            ...
            className={`flex items-center gap-1.5 sm:gap-2 px-2 sm:px-3 md:px-4 py-1.5 sm:py-2 rounded-lg transition-all duration-300 text-xs sm:text-sm ${
              isHomePage
        ...
        <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
          <Link href="/contacts">
            <Button
              ...
              } transition-all duration-300 shadow-md w-full sm:w-auto text-xs sm:text-sm px-4 sm:px-6 py-2`}
            >
          ...
          <Link href="/about">
            <Button
              ...
              } transition-all duration-300 w-full sm:w-auto text-xs sm:text-sm px-4 sm:px-6 py-2`}
            >
              Узнать больше
            </Button>
          </Link>
