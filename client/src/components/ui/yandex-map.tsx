...
export default function YandexMap({ address, className = "w-full h-64" }: YandexMapProps) {
  ...
  return (
    <div className="relative">
      {isLoading && (
        <div className={`absolute inset-0 ${className} rounded-lg bg-gray-100 flex items-center justify-center z-10`}>
          <div className="text-center text-gray-600">
