...
- July 12, 2025. Added Yandex Reviews widget integration with theme variants: dark theme for footer, light theme for contacts page with multiple size options
```
